  ...
  template: `
    <div class="soz-home">
        ...
        <div class="soz-card-grid">
          ...
          <mat-card class="soz-feature-card">
            <mat-card-content>
              ...
              Заёмщик подаёт заявку — платформа запрашивает данные в АИС КР и БКИ (мок) и сразу
        ...
        <mat-card class="soz-trust-card">
          ...
          <div>
            ...
            <p>
              ...
              в АИС КР, БКИ, ЕРИП и МСИ реализованы как заменяемые интеграции — сервис готов к
      ...
      <p class="soz-page soz-disclaimer">
        ...
        параметры. АИС КР, БКИ, ЕРИП, МСИ и SMS — мок-интеграции. Перед реальным использованием
